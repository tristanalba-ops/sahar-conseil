...
.article-body a{color:#00B86B;border-bottom:1px solid rgba(0,220,130,.25);transition:border-color .12s}
.article-body a:hover{border-color:#00DC82}
...
<head>
  ...
  *,*::before,*::after{{box-sizing:border-box;margin:0;padding:0}}
  ...
  :root{{--green:#00DC82;--green-l:#e6fff3;--accent:#00B86B;--ink:#1a1a1a;--ink2:#444;--ink3:#888;--bd:#e5e5e5;--bg2:#f8f8f8;--r:8px;--r2:12px;--mw:900px}}
  ...
  .nav-logo-dot{{width:8px;height:8px;background:#00DC82;border-radius:50%;display:inline-block}}
...
def build_blog_index(articles: list) -> str:
    ...
    for a in sorted(articles, key=lambda x: x.get("meta", {}).get("published_at", ""), reverse=True):
        ...
        cards += f"""
<a href="{slug}.html" style="display:block;border:1px solid #e5e5e5;border-radius:10px;padding:1.25rem;transition:border-color .15s" onmouseover="this.style.borderColor='#00DC82'" onmouseout="this.style.borderColor='#e5e5e5'">
  <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:.5rem">
    <span style="font-size:.72rem;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:#00DC82">{sect}</span>
